...
Original file is located at
    https://colab.research.google.com/drive/14MFx-4r4OjVmzA9xt-pMcht_rs477sOg
"""
...
import keras
#K
#from tensorflow.python.keras.backend import set_session   #hehehe
#from tensorflow.python.keras.models import load_model     #hehehe

'''tf_config = custom_config        #hehehe
sess = tf.Session(config=tf_config)      #hehehe
graph = tf.get_default_graph()'''  #hehehe
#K
...
# for test videos/content/drive/MyDrive/UWOT/BTPDv/
fish = '/content/drive/MyDrive/Metrics/TrackEval/data/gt/mot_challenge/f4k-train/'
# fish = '/content/drive/MyDrive/Metrics/TrackEval/data/gt/mot_challenge/f4k-train/'
# fish = '/content/drive/MyDrive/Metrics/TrackEval/data/gt/mot_challenge/f4k-train/'
...
for file in filenames:
  if cont >= 9 :
     ...
     data = pd.read_csv(fish+str(file)+'/det/'+'det.txt',names = cols)
    # print(data)
     print('Data Loaded......')
     image_folder = fish+str(file)+'/img2/'
     ...
     for image in images:
        ...
        if init == True and missing == False:
            ...
            for i in range(len(bnd_boxes)):
                ...
                with open('/content/drive/MyDrive/BTPK/Deep-Fish-Tracker-Network/BTPDV/'+file+'.txt','a+') as resfile:
        ...
        # Computing Cost Matrix        
            ...
            for i in range(len(bnd_boxes)):
                ...
                with open('Appearance_Siam_uwcnn_senet.txt', 'a') as testwritefile:
                    
                    for t in track_row:
                        testwritefile.write(str(t)+',')
